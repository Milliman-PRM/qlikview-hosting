...
C:\Windows\SysWOW64\inetsrv\appcmd.exe add app /site.name:"Default Web Site" /path:"/prm_ci_<<branch_name>>_WEBTestHarness" sGIT_BRANCH%\WEBTestHarnessphysicalPath:"D:\installedapplications\prm_ci\<<branch_name>>\WEBTestHarness" /applicationPool:"Qlikview IIS" 
