<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="MillimanSupport.Profile" %>
        ...
        <table style="border: 0px solid gray; width: 850px; margin: 0px auto;" cellspacing="5" id="PrimaryContainer">
                ...
                <td colspan="2" style="padding-right: 5px;">
                    <div id="NewUserMessage" style="background-color: white; width: 100%; display: block; border: 1px solid #316563">
                        <table border="0" style="padding: 5px; overflow: hidden; font-weight: 300; width: 100%" cellpadding="5">
                            <tr>
                                <td>
                                    <img src="css/milliman_small.jpg" style="border: 0px" />
                                </td>
                                <td valign="middle">You are required to change your password and complete your profile information before continuing.&nbsp; Passwords must have a minimum length of 7 characters with at least 1 non-alphanumeric character.
                                </td>
                            </tr>
                        </table>
                    </div>
                                ...
                                <div style="width: 400px;">
                                    ...
                                    <table cellpadding="5" style="border: 1px solid black; width: 400px; flex-align: center">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="Images/star-blue-icon.png" title="This field is required." id="CurrentPasswordIcon" /></td>
                                        </tr>
                                        <tr>
                                            <td align="right" style="width: 170px">
                                            ...
                                            <td>
                                                <img src="Images/star-blue-icon.png" title="This field is required." id="NewPasswordIcon" /></td>
                                        </tr>
                                        <tr>
                                            <td align="right" style="width: 170px">
                                            ...
                                            <td>
                                                <img src="Images/star-blue-icon.png" title="This field is required." id="ConfirmPasswordIcon" /></td>
                                        </tr>
                            ...
                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="SecretPhraseDropdown" runat="server">
                                                    <asp:ListItem Text="">What was the name of the city your grew up in?</asp:ListItem>
                                                    <asp:ListItem Text="">What was your first pets name?</asp:ListItem>
                                                    <asp:ListItem Text="">What model was your first car?</asp:ListItem>
                                                    <asp:ListItem Text="">What is your favorite city?</asp:ListItem>
                                                    <asp:ListItem Text="">Who manufactored your television?</asp:ListItem>
                                ...
                                <div id="UserMessages" style="border: 0px solid #DF3A01; margin: 5px; vertical-align: middle; display: none">
                                    <div style="float: left; padding: 5px">
                                        <img src="Images/warning-orange.png" />
                                    </div>
            ...
            <tr>
                <td colspan="2" style="flex-align: center; text-align: center">
                    <asp:Button ID="ChangePasswordPushButton" runat="server" CommandName="ChangePassword" Text="Apply Changes" OnClick="ChangePasswordPushButton_Click" OnClientClick="return Validate()" BackColor="#CEDBC5" BorderColor="#316563" BorderStyle="Solid" BorderWidth="1" Height="25px" Width="195px" />
