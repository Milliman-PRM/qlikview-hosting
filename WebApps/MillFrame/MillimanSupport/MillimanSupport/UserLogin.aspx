<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserLogin.aspx.cs" Inherits="MillimanSupport.UserLogin" %>
            ...
            <table style="border-collapse:collapse;border-color:#3F3F3F;">
                ...
                <tr style="background-color:#3F3F3F">
                    <td class="auto-style1"  >
                        ...
                        <td class="auto-style5"><a id="LostPassWord" href="mailto:HCIntel.Support@Milliman.com?&subject=Password%20Reset&body=Please%20reset%20my%20password%20on%20the%20HCIntel%20support%20website[http://hcintel.cloudapp.net]!" target="_top"  style="padding: 0px; margin: 0px; text-align:right; vertical-align:middle; font:400 9px arial; color:white; width:130px;visibility:hidden " >&nbsp;&nbsp;Password&nbsp;Reset</a></td>
                    ...
                    <td class="auto-style2">
                        <table style="visibility:hidden;" width="135" border="0" cellpadding="2" cellspacing="0" title="Click to verify Milliman's encrypted communication status">
                        <tr>
<%--                        <td width="135" align="center" valign="top"><script type="text/javascript" src="https://seal.verisign.com/getseal?host_name=hcintel.milliman.com&amp;size=S&amp;use_flash=YES&amp;use_transparent=YES&amp;lang=en"></script><br />
                        <a href="http://www.symantec.com/verisign/ssl-certificates" target="_blank"  style="color:#000000; text-decoration:none; font:bold 7px verdana,sans-serif; letter-spacing:.5px; text-align:center; margin:0px; padding:0px;"></a></td>--%>
                        <td width="135px" align="center" valign="middle">
                             <a href="https://trustsealinfo.verisign.com/splash?form_file=fdf/splash.fdf&dn=hcintel.milliman.com&lang=en" target="_blank"  style="color:#000000; text-decoration:none; font:bold 7px verdana,sans-serif; letter-spacing:.5px; text-align:center; margin:0px; padding:0px;"><img src="Images/NortonSecured.png" alt="Norton Secured" style="border:0px" /></a>
                        </td>
                        </tr>
                        </table>
                    </td>
