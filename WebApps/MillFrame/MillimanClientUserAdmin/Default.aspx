...
<body onresize="FullSize('MainTable');" style="background-image: url(Imates/watermark.png); overflow: hidden">
    <div id="zone" style="width: 100%; height: 100%">
        <form id="form1" runat="server">
            ...
            <telerik:RadWindowManager EnableShadow="true" Behaviors="Resize, Close, Maximize, Move, Reload"
                ID="RadWindowManager" DestroyOnClose="true" Opacity="100" runat="server" Width="450" Height="400"
                VisibleStatusbar="False" Style="z-index: 20000;" RestrictionZoneID="zone">
                <Windows>
