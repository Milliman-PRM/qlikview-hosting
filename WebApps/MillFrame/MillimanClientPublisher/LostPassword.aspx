<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LostPassword.aspx.cs" Inherits="ClientPublisher.LostPassword" %>
                    ...
                    <td colspan="5">
                        <table width="100%" style="border-collapse: collapse; background-color: #3F3F3F; border-width: 0px; border-color: #3F3F3F;">
                            ...
                            <tr>
                                <td colspan="2">
                                    <center>
                                        <asp:Label ID="lblErrorMessage" CssClass="error-1" runat="server">*A valid email and password are required!</asp:Label></center>
                                </td>
                                <td>&nbsp;</td>
