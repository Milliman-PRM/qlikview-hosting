...
{
    public partial class NoReduce : System.Web.UI.Page
    {
        public class SimpleUpdateClass : TaskBase
        {
            ...
            public void Process(object parms)
            {
                ...
                string BackupSet = ClientPublisher.PublisherUtilities.CreateBackupSet(ProjectSettings.AbsoluteProjectPath, BackupTo, System.IO.SearchOption.AllDirectories);
                ...
                try
                {
                    ...
                    if (Files != null)
                    {
                        ...
                        DisplayMessage = "Removing old reduction files......";
                ...
                try
                {
                    ClientPublisher.PublisherUtilities.RestoreBackupSet(ProjectSettings.AbsoluteProjectPath, BackupSet, System.IO.SearchOption.AllDirectories);
