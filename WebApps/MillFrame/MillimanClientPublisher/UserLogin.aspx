<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserLogin.aspx.cs" Inherits="ClientPublisher.UserLogin" %>
    ...
    <form id="myform" runat="server" defaultbutton="btnLogin" defaultfocus="txtUserName">
        <div class="logincontent">
            <table style="border-collapse:collapse;border-color:#3F3F3F;">
                ...
                <tr >
                    <td style="text-align:center;background-color:black;vertical-align:middle;" colspan="" class="Col1Style">
                        <asp:Label ID="lblErrorMessage" CssClass="error-1" runat="server">*A valid email and password are required!</asp:Label>
                    </td>
                    <td title="SFv2.11" style="text-align:right;background-color:black;color:white;height:30px;vertical-align:bottom;" colspan="4">
