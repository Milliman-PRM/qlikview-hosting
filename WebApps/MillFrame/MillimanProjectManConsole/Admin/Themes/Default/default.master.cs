...
public partial class admin_themes_default_default : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            if (string.IsNullOrEmpty(System.Configuration.ConfigurationManager.AppSettings["FriendlyServerName"]) == false)
                ServerName.Text = @"[" + System.Configuration.ConfigurationManager.AppSettings["FriendlyServerName"] + "]";
