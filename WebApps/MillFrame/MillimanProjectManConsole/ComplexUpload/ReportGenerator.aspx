<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportGenerator.aspx.cs" Inherits="MillimanProjectManConsole.ComplexUpload.ReportGenerator" %>
  ...
  <div class="CenterMeHorVer">
   ...
   <center><asp:Image ID="Image1" runat="server" ImageUrl="~/images/Roundedblocks.gif" /></center><br />
    ...
    <script type="text/javascript">
        ...
        var RW = GetRadWindow();
        if (RW.set_title)
            RW.set_title("Report Hierarchy Difference Report");
    </script>
</body>
</html>
