<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QVWExtractor.aspx.cs" Inherits="MillimanProjectManConsole.ComplexUpload.QVWExtractor" %>
  ...
  <div class="CenterMeHorVer">
   ...
   <center><asp:Image ID="Image1" runat="server" ImageUrl="~/images/Roundedblocks.gif" /></center><br />
    ...
    <script type="text/javascript">
        ...
        var RW = GetRadWindow();
        if (RW.set_title)
            RW.set_title("QVW Hierarchy Extraction Processing");
    </script>
</body>
</html>
