<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IndexBuilder.aspx.cs" Inherits="MillimanProjectManConsole.ComplexUpload.IndexBuilder" %>
  ...
  <div class="CenterMeHorVer">
   ...
   <center><asp:Image ID="Image1" runat="server" ImageUrl="~/images/Roundedblocks.gif" /></center><br />
    ...
    <script type="text/javascript">
        ...
        var RW = GetRadWindow();
        if (RW.set_title)
            RW.set_title("Hierarchy Index Generation");
    </script>
</body>
</html>
