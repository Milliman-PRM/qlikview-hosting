...
<div class="liWrap" style="font-size:10pt; width:200px">
    <div class="liTitle" style="font-size:12pt;text-align:center">
        <img s
            c="../images/PRMLogo_height80.png" style="width:99%"/>
        PASSWORD RECOVERY
    </div>
    ...
    <asp:PasswordRecovery ID="PasswordRecovery1" runat="server" OnSendingMail="PasswordRecovery1_SendingMail" OnVerifyingUser="PasswordRecovery1_VerifyingUser" SuccessText="Thank you! Your password has been sent to you." OnUserLookupError="PasswordRecovery1_UserLookupError">
        ...
        <UserNameTemplate>
            ...
            <br />
            <asp:TextBox ID="UserName" runat="server" MaxLength="50" ValidationGroup="PasswordRecovery1" ToolTip="enter your user name." Width="99%"></asp:TextBox>
            <div class="clearBoth2">
            </div>
            ...
            <asp:Button ID="SubmitButton" runat="server" CommandName="Submit" Text="Submit" ValidationGroup="PasswordRecovery1" Width="99%" />
        </UserNameTemplate>
        <QuestionTemplate>
            <div class="clearBoth2">
            </div>
