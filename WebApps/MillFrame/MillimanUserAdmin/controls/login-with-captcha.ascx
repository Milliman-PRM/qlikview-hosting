                ...
                <LayoutTemplate>
                    <asp:Panel ID="pnlLogin" runat="server" DefaultButton="LoginButton">
                        ...
                        <div title="enter the code shown on the image.">
                            <cc1:CaptchaControl ID="CAPTCHA" runat="server" LayoutStyle="Vertical" ShowSubmitButton="False" TabIndex="3" CaptchaFontWarping="Extreme" CssClass="captcha" ToolTip="enter the code shown above" />
                        </div>
                        <div class="clearBoth2">
                        </div>
...
<%--                        <br />
 ...
 <%--                       <asp:HyperLink ID="lnkLostPassword" style="font-size:8pt;text-align:center;width:99%"  runat="server" NavigateUrl="~/recover-password.aspx" Width="99%">I forgot my password!</asp:HyperLink>--%>
                    </asp:Panel>
                </LayoutTemplate>
            </asp:Login>
        </AnonymousTemplate>
