...
<div class="gvBanner">
    <span class="gvBannerThemes">
        <asp:Image ID="Image2" runat="server" ImageAlign="AbsMiddle" ImageUrl="~/images/decoy-icon-36px.png" /></span> Super Groups</div>
<div class="cuwWrap" id="container" style="position:absolute; top:150px; left:20px; width:1024px; height: 700px;z-index:-1;">
    ...
    <asp:CheckBox ID="UseCommaDelimited" runat="server" style="z-index: 1; left: 345px; top: 172px; position: absolute" Text="Use comma as multiple email delimiter" />
