                                ...
                                <asp:Panel runat="server" ID="SecurityInfoSection" Visible="false">
                                    ...
                                    <asp:GridView runat="server" ID="GridView1" AutoGenerateColumns="False" OnRowDataBound="GridView1_RowDataBound" CellPadding="4" CssClass="gv">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Move Rule" Visible="False">  <%--hide this for now, who cares we can move up and down--%>
                                                <ItemTemplate>
                                    ...
                                    <table cellpadding="3" cellspacing="0" style="width: 100%">
                                        <tr>
                                            <td style="width: 153px">
                                                <asp:RadioButton ID="ActionDeny" runat="server"  GroupName="action" Text="Deny" Visible="False" />
                                                <asp:RadioButton ID="ActionAllow" runat="server" GroupName="action" Checked="true" Text="Allow" Visible="False" />
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="auto-style1">
                                                <asp:CheckBox ID="RequiresPatientContext" runat="server" Checked="false" Text="Requires Patient Context" />
                                            </td>
                                            <td> Special Commands</td>
                                        </tr>
                                        <tr>
                                            <td style="width: 153px">
                                                <asp:RadioButton ID="ApplyRole" runat="server" Checked="true" GroupName="applyto" Text="This Group:" />
                                            </td>
                                            <td class="auto-style1">
                                            ...
                                            <td> <asp:TextBox ID="SpecialCommand" runat="server" Width="204px" /> </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 153px">
                                            ...
                                            <td>
                                                <asp:ListBox ID="UserList" Rows="12" Width="204px" SelectionMode="Single" runat="server" AutoPostBack="True" OnSelectedIndexChanged="UserList_SelectedIndexChanged" ></asp:ListBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 153px">
                                                <asp:RadioButton ID="ApplyAllUsers" runat="server" GroupName="applyto" Text="All Users (*)" Visible="False" />
                                            </td>
                                            <td class="auto-style1">
                                            </td>
                                            <td>&nbsp;</td>
                                        ...
                                        <tr>
                                            <td style="width: 153px">
                                                <asp:RadioButton ID="ApplyAnonUser" runat="server" GroupName="applyto" Text="Anonymous Users (?)" Visible="False" />
                                            </td>
                                            <td class="auto-style1">
                                            </td>
                                            <td>&nbsp;</td>
                                        ...
                                        <tr>
                                            <td style="width: 200px">
                                                <asp:Button ID="Button4" CssClass="inputButton" runat="server" OnClick="CreateRule" OnClientClick="return confirm('Click OK to create this rule.');" Text="Create Access Rule" />
                                            </td>
                                            <td class="auto-style1">
