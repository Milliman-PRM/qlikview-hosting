...
<asp:Panel ID="pnlHideItems" runat="server" Visible="false">
    ...
    <div class="buttonCSS">
        <asp:LinkButton ID="deleteAllUsers" runat="server" OnClick="deleteAllUsers_Click" ToolTip="DELETE ALL membership USERS and ALL related information." OnClientClick="return confirm('DELETE ALL membership USERS and ALL related information.? Warning! This action connot be reversed. If in doubt, backup your database first.');" Visible="False">Delete All</asp:LinkButton>
    </div>
    ...
    <div class="buttonCSS">
        <asp:LinkButton ID="btnRemoveAllUsersFromAllRoles" runat="server" OnClick="btnRemoveAllUsersFromAllRoles_Click" OnClientClick="return confirm('REMOVE ALL USERS from ALL GROUPS?');" ToolTip="REMOVE ALL users from ALL GROUPS." EnableViewState="False">Remove All From Groups</asp:LinkButton>
    </div>
