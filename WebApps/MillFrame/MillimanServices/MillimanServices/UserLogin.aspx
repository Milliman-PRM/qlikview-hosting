<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserLogin.aspx.cs" Inherits="Milliman.UserLogin" %>
...
<%--                        <td width="135" align="center" valign="top"><script type="text/javascript" src="https://seal.verisign.com/getseal?host_name=hcintel.milliman.com&amp;size=S&amp;use_flash=YES&amp;use_transparent=YES&amp;lang=en"></script><br />
                        ...
                        <td width="135px" align="center" valign="middle">
                             <a href="https://trustsealinfo.verisign.com/splash?form_file=fdf/splash.fdf&dn=hcintel.milliman.com&lang=en" target="_blank"  style="color:#000000; text-decoration:none; font:bold 7px verdana,sans-serif; letter-spacing:.5px; text-align:center; margin:0px; padding:0px; visibility: hidden;"><img src="Images/NortonSecured.png" alt="Norton Secured" style="border:0px" /></a>
                        </td>
                        </tr>
                        </table>
                    </td>
