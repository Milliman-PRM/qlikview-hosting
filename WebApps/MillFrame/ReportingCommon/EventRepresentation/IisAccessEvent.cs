...
namespace ReportingCommon
{
    public class IisAccessEvent : UserEventBase
    {
        ...
        /// <returns></returns>
        public IisEventType GetEventType(IisLogFileEntry Entry)
        {
            if (Entry.IsLogin())
            {
        ...
        private string GetBrowserFromAgentString(string UserAgent)
        {
        ...
        private string TrimEndNonDigit(string Value)
        {
