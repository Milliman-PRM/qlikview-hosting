    ...
    static public class Utilities
    {
        ...
        public static void Log(ReportType _ReportType, string Msg, Exception ex = null)
        {
            try
            {
                ...
                string ReportDirectory = System.IO.Path.GetDirectoryName(System.Web.HttpContext.Current.Server.MapPath(LogFile));
                if (System.IO.Directory.Exists(ReportDirectory) == false)
