...
namespace CLSConfigurationCommon
{
    public static class DatabaseConnectionStringParser
    {
        ...
        static readonly string[] schemaAliases = { "Initial Schema" };
        static readonly string[] databaseAliases = { "database", "initial catalog" };
        static readonly string[] usernameAliases = { "user id", "uid", "username", "user name", "user", "User Id" };
        static readonly string[] passwordAliases = { "password", "pwd", "Password" };
        ...
        public static string GetSchemaName(string connectionString)
        {
            return GetValue(connectionString, schemaAliases);
        }
