...
start /wait PrmServerMonitor.exe console orphantaskremoval managecals reportnamedcalassigned reportnamedcallimit reportdocumentcalassigned reportdocumentcallimit
